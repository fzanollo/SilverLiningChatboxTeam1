...
namespace Microsoft.BotBuilderSamples
{
    public static class Cards
    {
        ...
        public static ThumbnailCard GetThumbnailCard1()
        {
            var thumbnailCard = new ThumbnailCard
            {
                Title = "Time Challenge!",
                Subtitle = "Game 1",
                Text = "You will have an X amount of time to answer" +
                       " as many questions as you can!",
                Images = new List<CardImage> { new CardImage("https://png.pngtree.com/png-clipart/20190614/original/pngtree-vector-clock-icon-png-image_3782163.jpg") },
                //Buttons = new List<CardAction> { new CardAction(ActionTypes.OpenUrl, "Get Started", value: "https://docs.microsoft.com/bot-framework") },
            };
        ...
        public static ThumbnailCard GetThumbnailCard2()
        {
            var thumbnailCard = new ThumbnailCard
            {
                Title = "Points Challenge!",
                Subtitle = "Game 2",
                Text = "For each question that you have right you will earn 5 points, each time you answer incorrectly" +
                       "you lose one life, you have 3 in total so be careful!",
                Images = new List<CardImage> { new CardImage("https://www.clipartmax.com/png/middle/134-1346808_trophy-animation-trophy-icon.png") },
                //Buttons = new List<CardAction> { new CardAction(ActionTypes.OpenUrl, "Get Started", value: "https://docs.microsoft.com/bot-framework") },
            };
        ...
        public static ThumbnailCard GetThumbnailCard3()
        {
            var thumbnailCard = new ThumbnailCard
            {
                Title = "Casual Challenge",
                Subtitle = "Game 3",
                Text = "You have unlimited lives and unlimited time" +
                       "tell us when you want to stop!",
                Images = new List<CardImage> { new CardImage("https://images.vexels.com/media/users/3/137627/isolated/preview/012f7bd53633f5a6e78e60ea08948c55-minimalist-infinity-logo-by-vexels.png") },
                //Buttons = new List<CardAction> { new CardAction(ActionTypes.OpenUrl, "Get Started", value: "https://docs.microsoft.com/bot-framework") },
            };
